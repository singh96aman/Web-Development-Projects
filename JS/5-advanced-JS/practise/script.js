...
function init(){
    ...
    QuestionArray.push(new Question('What is my Name',['Aman','Singh','Thakur'],0))
    QuestionArray.push(new Question('What is the place of my birth',['Punjab','Lucknow','Goa'],1))
    QuestionArray.push(new Question('What is my nature',['friendly','serious','naughty'],2))
...
function askQuestion(QuestionArray, score){
    ...
    if((ans-1)==QuestionArray[quesno].correct){
